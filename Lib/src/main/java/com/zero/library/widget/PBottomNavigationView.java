...
//        ImageView img = getField(BottomNavigationItemView.class, getBottomNavigationItemView(3), "mIcon");
        badgeView.bindTarget(getBottomNavigationItemView(3));//绑定消息按钮
    }
    ...
    private void setCenterIcon(){
        ...
        layoutParams.width = DensityUtils.dp2px(getContext(), 44);
        layoutParams.height = DensityUtils.dp2px(getContext(), 44);
